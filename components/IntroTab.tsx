      ...
      <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 md:p-12 shadow-sm">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-green max-w-none text-slate-700 space-y-8 leading-relaxed text-[15px]">
            ...
            {/* Dokumentų Sekcija - Vizualus atnaujinimas pagal pavyzdį */}
            <div className="space-y-4 my-12">
              <p className="font-black text-slate-900 uppercase tracking-tight text-lg m-0 mb-6">Svarbūs dokumentai:</p>
              
              {/* Dokumentas 1: Situacijų valdymas */}
              <div className="bg-blue-50/50 p-8 md:p-10 rounded-[2.5rem] border border-blue-100 relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-8 opacity-5 text-blue-600 pointer-events-none group-hover:scale-110 transition-transform duration-700">
                    <FileText size={120} />
                </div>
                <div className="flex items-center space-x-4 mb-8 relative z-10">
                    ...
                    <h4 className="font-black text-blue-900 uppercase tracking-tight m-0 text-xl md:text-2xl leading-tight">
                      IŠSAMUS SITUACIJŲ VALDYMO DOKUMENTAS
                    </h4>
                </div>
                
                <p className="text-slate-700 font-bold mb-8 text-lg leading-relaxed relative z-10">
                  Siekdami užtikrinti vieningą reagavimą, parengėme detalias gaires, kurias galite rasti <span className="font-black border-b-2 border-slate-900">Google Docs</span> platformoje:
                </p>
                
                <a 
                  href="https://docs.google.com/document/d/108fN0vGKqQ8gP5I6hy4QgemoPIenAYZoq7fugSKMmrE/edit?usp=sharing" 
                  target="_blank"
                  className="inline-flex items-center space-x-3 px-8 py-4 bg-white border border-blue-100 text-blue-700 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all shadow-sm hover:shadow-md relative z-10"
                >
                  <span>Atidaryti dokumentą</span>
                  <ArrowRight size={14} />
                </a>
              </div>
              ...
              <div className="bg-blue-50/50 p-8 md:p-10 rounded-[2.5rem] border border-blue-100 relative overflow-hidden group">
                ...
                <div className="flex items-center space-x-4 mb-8 relative z-10">
                    ...
                    <h4 className="font-black text-blue-900 uppercase tracking-tight m-0 text-xl md:text-2xl leading-tight">
                      POVEIKIO PRIEMONIŲ TAIKYMO DOKUMENTAS
                    </h4>
                </div>
                
                <p className="text-slate-700 font-bold mb-8 text-lg leading-relaxed relative z-10">
                  Susipažinkite su oficialiomis poveikio priemonėmis ir jų taikymo tvarka mokykloje:
                </p>
